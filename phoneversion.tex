...
\newwatermark[oddpages,fontfamily=bch,color=gray!25,angle=45,scale=2,xpos=0,ypos=0]{For Academic Purposes Only}
\newwatermark[evenpages,fontfamily=bch,color=gray!25,angle=-45,scale=2,xpos=0,ypos=0]{请注意引用规范}
\hypersetup{pdfinfo={
...
\usepackage[papersize={207mm,368mm},scale={0.8,0.85}]{geometry}
